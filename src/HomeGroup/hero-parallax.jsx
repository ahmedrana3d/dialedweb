...
export const HeroParallax = ({ products }) => {
  ...
  // Use useTransform directly for a linear, immediate response to scroll
  ...
  return (
    <div
      ref={ref}
      className="h-[220vh] py-52 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0 z-50 pointer-events-none">
      <h1 className="headline two-title py-3">Featured Projects</h1>
